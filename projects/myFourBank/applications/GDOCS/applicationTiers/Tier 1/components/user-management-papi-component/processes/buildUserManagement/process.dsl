...
process 'buildUserManagement', {
  ...
  processStep 'prepBuild', {
    actualParameter = [
      'commandToRun': new File(projectDir, "./applications/GDOCS/applicationTiers/Tier 1/components/user-management-papi-component/processes/buildUserManagement/processSteps/prepBuild.cmd").text,
      'shellToUse': '/bin/sh',
    ]
    alwaysRun = '0'
  ...
  processStep 'buildWithJenkins', {
    actualParameter = [
      ...
      'job_name': 'myFourBankCloud/job/Application_Delivery_Framework/job/CloudBeeFlow-PoV/job/gdocs-use-case/job/SPCOEPTL-191-User-Management-CBF',
  ...
  processStep 'getSonarResults', {
    actualParameter = [
      'commandToRun': new File(projectDir, "./applications/GDOCS/applicationTiers/Tier 1/components/user-management-papi-component/processes/buildUserManagement/processSteps/getSonarResults.cmd").text,
      'shellToUse': '/bin/sh',
    ]
    alwaysRun = '0'
    dependencyJoinType = 'and'
  ...
  processStep 'updateSonarResults', {
    actualParameter = [
      'commandToRun': new File(projectDir, "./applications/GDOCS/applicationTiers/Tier 1/components/user-management-papi-component/processes/buildUserManagement/processSteps/updateSonarResults.cmd").text,
      'shellToUse': '/bin/sh',
    ]
    alwaysRun = '0'
    dependencyJoinType = 'and'
